      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">
            How the Academic Intake Workflow Operates
          </h2>
          <p className="mt-3 text-slate-600 text-sm leading-relaxed">
            From initial FAYDA digital ID submission to committee review and Skillsoft Percipio platform onboarding.
          </p>
        </div>
          ...
          {processSteps.map((step, idx) => (
            <div key={step.step} className="step-card">
              <Card className="h-full flex flex-col p-6 relative group hover:border-blue-400 bg-slate-50/80 border-slate-200/90 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-xs text-slate-600 leading-relaxed flex-grow">{step.description}</p>
        ...
        <div className="mt-14 text-center">
          <Link href="/apply">
            <Button size="lg" className="group px-8 py-4 shadow-lg shadow-blue-600/20">
              <span>Begin Step 01: Online Application</span>
